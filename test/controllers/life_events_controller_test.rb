...
class LifeEventsControllerTest < ActionController::TestCase
  ...
  test "should create life_event" do
    assert_difference('LifeEvent.count') do
      post :create, life_event: { date: @life_event.date, description: @life_event.description, event_title: @life_event.event_title }
    end
  ...
  test "should update life_event" do
    patch :update, id: @life_event, life_event: { date: @life_event.date, description: @life_event.description, event_title: @life_event.event_title }
    assert_redirected_to life_event_path(assigns(:life_event))
  end
